...
\usepackage{tabu}
\usepackage{colortbl}
\usepackage{array, booktabs, arydshln, xcolor, tabu}
\usepackage{cals}
\usepackage{multirow}
...
\tableofcontents
\input{Library/1-MS}
\input{Library/2-Analysis}
\input{Library/3-Planung}
\input{Library/4-Projekt}
\input{Library/5-Implementation}
\input{Library/6-Test}
\input{Library/7-Reflektion}
\end{normalsize}
