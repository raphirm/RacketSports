...
Als Server Test Framework wird Mocha - eins NodeJS/ExpressJS Testsquite verwendet. Models sowie Controller werden hier getestet. 
...
\end{lstlisting}
Der erste Test prüft, ob ein valides (zuvor erstelltes) Court-Objekt  problemlos gespeichert werden kann. Dafür wird die court.save() Funktion aufgerufen und geprüft ob es ein Error gibt.
...
Zusätzlich zu den Unit Tests werden die Anforderungen manuell getestet mithilfe eines Systemtests. Zuerst werden Testfälle für Anforderungen erstellt, diese Ausgeführt und das erwartete mit dem tatsächlichem Ergebnis verglichen. 
\newpage
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Beschreibung}} &  
		\cellcolor{testblau}{Dieser Test prüft, ob die Registrierung mit einem schon User  einen Fehler gibt }
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Version}} &
		\cellcolor{testblau} 1.0
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\textcolor{white}{\textbf{\cellcolor{airforceblue}User registriert und de registriert sich in Racketsportzentrum}}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Beschreibung}} &  
		\cellcolor{testblau}{Der User wählt ein Racketsportzentrum aus und registriert sich in das Racketsportzentrum }
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Version}} &
		\cellcolor{testblau} 1.0
		...
		\itemsep -0.4em
			...
			\item Ein Racketsportzentrum auswählen.
			\item Auf Ich will mitspielen drücken, um sich mit dem Racketsportzentrum zu registrieren.
			\item Auf ich will nicht mehr mitspielen drücken, um sich auszutragen.
		\end{enumerate}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Erwartetes Resultat}} &
		\cellcolor{testblau}	
		Nach Schritt 3 muss der User in der Liste des Racketsportzentrums auftauchen. Nach Schritt 4 muss der User aus der Liste verschwinden
	\end{longtabu}
\end{center}
\begin{center}
	\tabulinesep = 1mm
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Beschreibung}} &  
		\cellcolor{testblau}{Spieler 1 lädt Spieler 2 ein, einen Freund zu werden. Spieler 2 sieht die Einladung und kann sie annehmen oder ablehnen}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Version}} &
		\cellcolor{testblau} 1.0
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Erwartetes Resultat}} &
		\cellcolor{testblau}	
		Ein Fehler wird zurückgegeben, das der User nicht gefunden wurde.
	\end{longtabu}
\end{center}
\begin{center}
	\tabulinesep = 1mm
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\end{itemize}REQ2.01 - Spiel erstellen
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Testschritte }} &
		\cellcolor{testblau}
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Erwartetes Resultat}} &
		\cellcolor{testblau}	
		Bei abschicken sollte ein Fehler erscheinen das das Spiel nicht vollständig ausgefüllt wurde.
	\end{longtabu}
\end{center}
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\itemsep -0.4em
			\item Navigieren zur Spieleseite (webserver/matches)
			\item Ein Spielvorschlag auswählen
			\item Ein Terminvorschlag wählen
			\item Spiel abschicken
		\end{enumerate}
		\tabularnewline
		\tabucline[2pt]{-}
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Beschreibung}} &  
		\cellcolor{testblau}{Der Spieler erstellt ein Broadcast Spiel für das Racketsportzentrum}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Version}} &
		\cellcolor{testblau} 1.0
		...
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Erwartetes Resultat}} &
		\cellcolor{testblau}	
		Spieler im gleichen Racketsportzentrum sehen das Spiel.
	\end{longtabu}
\end{center}
\begin{center}
	\tabulinesep = 1mm
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\itemsep -0.4em
			...
			\item Spiel in den Status In Progress setzen
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\begin{enumerate}
		\itemsep -0.4em
			\item Spieler 1: Erstellt Spiel mit Terminvorschläge
			\item Spieler 2: Bestätigt ein Terminvorschlag
			\item Spieler 1: Bestätigt Bestätigung des Terminvorschlag
			\item Spieler 1: Eröffnet Spiel
			\item Spieler 2: Trägt Resultat ein
			\item Spieler 1: Bestätigt Resultat
			\item Spieler 1 und 2: Findet Spiel in Archiv
		\end{enumerate}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Erwartetes Resultat}} &
		\cellcolor{testblau}	
			Beide Spieler finden Spiel in archiv
	\end{longtabu}
\end{center}
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Erfolgreich ein Court erstellen}}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Beschreibung}} &  
		\cellcolor{testblau}{Sobald das Spiel beendet wurde, kann das Ergebnis eingetragen werden}
		...
		\itemsep -0.4em
			...
			\item Ein neues Court erstellen
		\end{enumerate}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Erwartetes Resultat}} &
		\cellcolor{testblau}	
		Die eingegebenen Details in der Court Detail Seite ersichtlich.
	\end{longtabu}
\end{center}
\begin{center}
	\tabulinesep = 1mm
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Erfolglos ein Court erstellen}}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Beschreibung}} &  
		\cellcolor{testblau}{Koordinaten für das Court sind obligatorisch, wenn eine Koordinate fehlt, das Court sollte nicht erstellt werden, dafür ein Fehler kommen. }
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Version}} &
		\cellcolor{testblau} 1.0
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Spieler können sich in Court eintragen}}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Beschreibung}} &  
		\cellcolor{testblau}{Spieler kann sich bei Court registrieren, und anschliessend de registrieren }
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Version}} &
		\cellcolor{testblau} 1.0
		...
		\itemsep -0.4em
			...
			\item Sichin Court ausschreiben
		\end{enumerate}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Erwartetes Resultat}} &
		\cellcolor{testblau}	
		Nach 3. Schritt sollte der User in der Liste der Spieler vom Court auftauchen, nach Schritt 4 sollte er wieder verschwunden sein.
	\end{longtabu}
	\end{center}
\begin{center}
	\tabulinesep = 1mm
	...
	\begin{center}
		...
		\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
			...
			\tabucline[2pt]{-}
			\textcolor{white}{\textbf{\cellcolor{airforceblue}Beschreibung}} &  
			\cellcolor{testblau}{Spieler kann sich bei Liga registrieren, und anschliessend de registrieren  }
			\tabularnewline
			\tabucline[2pt]{-}
			\textcolor{white}{\textbf{\cellcolor{airforceblue}Version}} &
			\cellcolor{testblau} 1.0
	...
	\begin{center}
		...
		\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
			...
			\tabucline[2pt]{-}
			\textcolor{white}{\textbf{\cellcolor{airforceblue}Beschreibung}} &  
			\cellcolor{testblau}{Bei Abschluss eines Spiels wird die Rangliste der Liga aktualisiert}
			\tabularnewline
			\tabucline[2pt]{-}
			\textcolor{white}{\textbf{\cellcolor{airforceblue}Version}} &
			\cellcolor{testblau} 1.0
...
\begin{center}
		...
		\begin{longtabu} to \linewidth {p{1.5cm}|[2pt]X[1, m , l]|[2pt]X[1, m , l]|[2pt]p{1.5cm}}
			...
			\cellcolor{testblau}Nach Schritt 3 muss der User in der Liste des Racketsportzentrums
...
vorhanden.&
			...
			\cellcolor{testblau}Ein Fehler wird zurückgegeben, das der User nicht gefunden wurde.&
			...
			\cellcolor{notokay}Bei abschicken sollte ein Fehler erscheinen das das Spiel nicht
...
den neuen Vorschlagen auswählen&
			...
			\cellcolor{testblau}Spieler im gleichen Racketsportzentrum sehen das Spiel.&
			\cellcolor{testblau}Spieler im gleichen Racketsportzentrum sehen das Spiel.&
			\cellcolor{testblau} OK
			\tabularnewline
			\tabucline[2pt]{-}
			...
			\cellcolor{testblau}Beide Spieler finden Spiel in Archiv&
			\cellcolor{testblau}Beide Spieler finden Spiel in Archiv&
			\cellcolor{testblau} OK
			\tabularnewline
			\tabucline[2pt]{-}
			\cellcolor{testblau} TE03.01 &
			\cellcolor{testblau}Die eingegebenen Details in der Court Detail Seite ersichtlich.&
			...
			\cellcolor{testblau}Nach 3. Schritt sollte der User in der Liste der Spieler vom Court auftauchen, nach Schritt 4 sollte er wieder verschwunden sein.&
