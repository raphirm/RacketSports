...
\paragraph{Stacks} Ein Stack für Spring, der alle Plug-Ins und Client MVCs mitbringt heisst JHipster \cite{jhipster}. Dieser Stack bringt eine Userverwaltung, Integration von Persistance Layer, Client MVC (AngularJS) und vieles weiter. Die Installation ist komplex und schwer verständlich. 
