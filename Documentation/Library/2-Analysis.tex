...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\cellcolor{testblau}
		\begin{tabular}[x]{@{}l@{}}
			REQ 0.1 - Anmeldung an das System\\
			REQ 0.2 - Registrierung im System 
			\end{tabular}
			\tabularnewline
			\tabucline[2pt]{-}
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\cellcolor{testblau}
		\begin{tabular}[x]{@{}l@{}}
			REQ 1.1 - Zuteilung zu Regionen\\
			REQ 1.2 - Broadcast Herausforderungen\\
			REQ 1.3 - Details zu Spieler\\
			REQ 1.4 - Friend System
		\end{tabular}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Testfälle}} &
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Vorbedingung}} &
		\cellcolor{testblau} UC0
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Anforderungen}} &
		\cellcolor{testblau}
		\begin{tabular}[x]{@{}l@{}}
			REQ 2.1 - Spiel erstellen \\
			REQ 2.2: Spielterminvorschläge erstellen\\
			REQ 2.3: Spielterminvorschläge annehmen\\
			REQ 2.4: Spielterminvorschläge ablehnen\\
			REQ 2.5: Regelmässiges Spiel erstellen
		\end{tabular}
		\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Testfälle}} &
...
\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\cellcolor{testblau}
		\begin{tabular}[x]{@{}l@{}}
			REQ 3.1 - Ergebnisse des Spiels eintragen \\
			REQ 3.2: Bestätigung der Ergebnisse
...
\begin{center}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\cellcolor{testblau}
		\begin{tabular}[x]{@{}l@{}}
			REQ 4.1: User in die Liga einladen \\
			REQ 4.2: Als User einer Liga beitreten
...
\FloatBarrier
\newpage
\subsubsection{UC 4.3 -Rangliste durch Spiele aktualisieren}
	...
	\begin{longtabu} to \linewidth [m]{|[2pt]p{3cm}|[2pt]X[1, m , l]|[2pt]}
		...
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Anforderungen}} &
		\cellcolor{testblau}REQ 4.4 - Spiele zu Liga zuordnen \\
	\cellcolor{airforceblue}&\cellcolor{testblau}REQ 4.5 - Aktualisierung der Ranglist bei gespielten Spielen
	\tabularnewline
	\tabucline[2pt]{-}
	\textcolor{white}{\textbf{\cellcolor{airforceblue}Testfälle}} &
	...
	\tabularnewline
	\tabucline[2pt]{-}
	\textcolor{white}{\textbf{\cellcolor{airforceblue}Szenarien}} & 	\cellcolor{testblau}		\includegraphics[width=0.7\textwidth]{Graphics/UC4_2.png}
	\tabularnewline
	\tabucline[2pt]{-}
	\textcolor{white}{\textbf{\cellcolor{airforceblue}Alternative Szenarien}} & 	\cellcolor{testblau}		\includegraphics[width=0.7\textwidth]{Graphics/UC4_2.png}\\
	\cellcolor{airforceblue}&\cellcolor{testblau}\includegraphics[width=0.6\textwidth]{Graphics/UC4_2.png}
	\tabularnewline
	\tabucline[2pt]{-}
...
\begin{table*}[ht]
	...
	\tabulinesep = 1mm
	\begin{tabu} to \linewidth [m]{|[2pt]X[-1,m, l]|[2pt]X[1, m , l]|[2pt]}
		\arrayrulecolor{white}
		...
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Anforderungen}} &
		\cellcolor{testblau}REQ 4.6 - Automatische Spielaufforderungen 
			\tabularnewline
		\tabucline[2pt]{-}
		\textcolor{white}{\textbf{\cellcolor{airforceblue}Testfälle}} &
		\cellcolor{testblau} Test1.1: Test \\
...
\subsubsection{Nicht funtionale Anforderungen}
